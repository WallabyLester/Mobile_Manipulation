...
def MobileManipulation():
    ...
    curr_config = np.array([0.1, -0.5, 0.1, 0, -0.2, 0.2, -0.2, 0, 0, 0, 0, 0, 0])     # best
    # curr_config = np.array([0.1, -0.5, 0.1, 0.2, -0.2, 0.6, -0.2, 0, 0, 0, 0, 0, 0])     # newTask
    # curr_config = np.array([0.1, -0.5, 0.5, 0.2, -0.2, 0.6, -0.2, 0, 0, 0, 0, 0, 0])    # overshoot
    # curr_config = np.array([0.1, -0.5, 0.5, 0.2, -0.2, 0.6, -0.2, 0, 0, 0, 0, 0, 0]) 
    # curr_config = np.array([0.1, 0.2, 0.5, 1.0, -0.6, 0.6, -1.0, 0.6, 0, 0, 0, 0, 0]) 
    ...
    # # use config for joint colliding
    ...
    # max_speed = 30      # best
    max_speed = 50    # nexTask and overshoot
    dt = 0.01
